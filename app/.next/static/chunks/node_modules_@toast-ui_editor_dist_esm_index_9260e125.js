(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_@toast-ui_editor_dist_esm_index_9260e125.js", {

"[project]/node_modules/@toast-ui/editor/dist/esm/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s({
    ...
    "EditorCore": (()=>ToastUIEditorCore),
    "default": (()=>ToastUIEditor)
});
...
var css_1 = css;
/* eslint-disable complexity */ var isArray$1 = isArray_1;
/**
 * @module array
 */ /**
...
function createTextSelection(tr, from, to) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextSelection"].create(tr.doc, Math.min(from, size), Math.min(to, size));
}
...
function replaceTextNode(_a) {
    ...
    for(var i = startIndex; i <= endIndex; i += 1){
        ...
        var node = text ? createTextNode$1(schema, text) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].empty;
...
function getInlineMarkdownText(mdNode) {
    ...
    switch(mdNode.type){
        ...
        case 'link':
        case 'image':
            /* eslint-disable no-case-declarations */ var _a = mdNode, destination = _a.destination, title = _a.title;
 ...
 */ function createNodesWithWidget(text, schema, ruleIndex) {
    ...
    if (rule && rule.test(text)) {
        ...
        while((index = text.search(rule)) !== -1){
            ...
            nodes.push(schema.nodes.widget.create({
                info: info
        ...
        nodes = ruleIndex < widgetRules.length - 1 ? mergeNodes(nodes, text, schema, nextRuleIndex) : [
            schema.text(text)
        ];
    }
    return nodes;
...
function getDefaultCommands() {
    return {
        deleteSelection: function() {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteSelection"];
        },
        selectAll: function() {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["selectAll"];
        },
        undo: function() {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$history$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["undo"];
        },
        redo: function() {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$history$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redo"];
        }
    };
}
            ...
            decorations: function(state) {
                ...
                if (options.text && doc.childCount === 1 && doc.firstChild.isTextblock && doc.firstChild.content.size === 0) {
                    ...
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DecorationSet"].create(doc, [
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Decoration"].widget(1, placeHolder)
                    ]);
                }
                return null;
            }
...
function appendNodes(node, nodesToAppend) {
    nodesToAppend = isArray_1(nodesToAppend) ? toArray_1(nodesToAppend) : [
        nodesToAppend
    ];
...
var pluginKey$1 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PluginKey"]('widget');
var MARGIN = 5;
...
var Node$2 = function() {
    function Node1() {}
    Object.defineProperty(Node1.prototype, "type", {
        get: function() {
            return 'node';
        },
        enumerable: false,
    ...
    Node1.prototype.setContext = function(context) {
...
var EditorBase = function() {
    ...
    EditorBase.prototype.createState = function() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorState"].create({
            schema: this.schema,
    ...
    Object.defineProperty(EditorBase.prototype, "defaultPlugins", {
        get: function() {
            ...
            var plugins = __spreadArray$1(__spreadArray$1([], this.keymaps), [
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$keymap$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["keymap"])(__assign$1({
                    'Shift-Enter': __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["baseKeymap"].Enter
    ...
    EditorBase.prototype.createInputRules = function() {
        ...
        var rules = widgetRules.map(function(_a) {
            var rule = _a.rule;
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$inputrules$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InputRule"](rule, function(state, match, start, end) {
        ...
        return rules.length ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$inputrules$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["inputRules"])({
            rules: rules
        }) : null;
    };
    ...
    EditorBase.prototype.createKeymaps = function(useCommandShortcut) {
        ...
        return useCommandShortcut ? allKeymaps.concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$keymap$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["keymap"])(historyKeymap)) : allKeymaps;
    };
...
function resolveSelectionPos(selection) {
    ...
    if (selection instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AllSelection"]) {
        return [
            from + 1,
            to - 1
        ];
...
function getEditorToMdPos(doc, from, to) {
    ...
    return [
        [
            startLine,
            startCh + getWidgetNodePos(doc.child(startLine - 1), startCh, -1)
        ],
        [
            endLine,
            endCh + getWidgetNodePos(doc.child(endLine - 1), endCh, -1)
        ]
    ];
}
...
function heading$1(_a, start, end) {
    ...
    if (headingType === 'atx') {
        ...
        marks.push(markInfo(setOffsetPos(end, 0), end, HEADING, {
            seText: true
        }));
    }
    return marks;
...
function markLink(start, end, linkTextStart, lastChildCh) {
    return [
        ...
        markInfo(setOffsetPos(end, lastChildCh + 2), addOffsetPos(end, -1), LINK, {
            url: true
        })
    ];
}
...
function code(_a, start, end) {
    ...
    return [
        ...
        markInfo(start, openDelimEnd, CODE, {
            start: true
        }),
        markInfo(openDelimEnd, closeDelimStart, CODE, {
            marked: true
        }),
        markInfo(closeDelimStart, end, CODE, {
            end: true
        })
    ];
}
function lineBackground(parent, start, end, prefix) {
    var defaultBackground = {
        ...
        spec: {
            attrs: {
                className: prefix + "-line-background",
                codeStart: start[0],
                codeEnd: end[0]
            }
        },
    ...
    return parent.type !== 'item' && parent.type !== 'blockQuote' ? [
        __assign$1(__assign$1({}, defaultBackground), {
            end: start,
            spec: {
                attrs: {
                    className: prefix + "-line-background start"
                }
            }
        }),
        __assign$1(__assign$1({}, defaultBackground), {
            start: [
                Math.min(start[0] + 1, end[0]),
                start[1]
            ]
        })
    ] : null;
...
function codeBlock$1(node, start, end, endLine) {
    ...
    var marks = [
        markInfo(setOffsetPos(start, 1), end, CODE_BLOCK)
    ];
    if (fenceChar) {
...
function customBlock$2(node, start, end) {
    ...
    var marks = [
        markInfo(setOffsetPos(start, 1), end, CUSTOM_BLOCK)
    ];
...
function blockQuote$2(node, start, end) {
    var marks = node.parent && node.parent.type !== 'blockQuote' ? [
        markInfo(start, end, BLOCK_QUOTE)
    ] : [];
    if (node.firstChild) {
        var childMarks = [];
...
function item$1(node, start) {
    ...
    var marks = [
        markInfo.apply(void 0, __spreadArray$1([
            start,
            addOffsetPos(start, padding)
        ], spec))
    ];
    if (task) {
...
function getMarkInfo(node, start, end, endLine) {
    ...
    if (simpleMarkClassNameMap[type]) {
        return [
            markInfo(start, end, simpleMarkClassNameMap[type])
        ];
    }
    return null;
}
...
function isDifferentBlock(doc, index, attrs) {
    return Object.keys(attrs).some(function(name) {
        return attrs[name] !== doc.child(index).attrs[name];
    });
}
...
var reBlockQuote = /^\s*> ?/;
var BlockQuote$1 = function(_super) {
            ...
            return {
                toDOM: function() {
                    return [
                        'span',
                        {
                            class: clsWithMdPrefix('block-quote')
                        },
                        0
                    ];
                }
...
var otherNodeToList = {
    ...
    ordered: function(_a) {
        ...
        for(var i = startLine - 1; i > 0; i -= 1){
            ...
            var canBeListNode = text && !!findClosestNode(mdNode, function(targetNode) {
...
var extendList = {
    ...
    ordered: function(_a) {
        ...
        var filteredList = backwardList.filter(function(info) {
            ...
            return searchResult && searchResult[1].length === indent.length && !!findClosestNode(info.mdNode, function(targetNode) {
...
var Paragraph$1 = function(_super) {
            ...
            return {
                ...
                toDOM: function(_a) {
                    ...
                    return attrs.className ? [
                        'div',
                        {
                            class: clsWithMdPrefix(attrs.className)
                        },
                        0
                    ] : [
                        'div',
    ...
    Paragraph.prototype.deleteLines = function() {
        ...
        return function(state, dispatch) {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chainCommands"])(deleteRange, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["joinForward"])(state, dispatch, view);
        };
    };
    Paragraph.prototype.moveDown = function() {
        return function(state, dispatch) {
            ...
            if (endIndex < doc.content.childCount - 1) {
                ...
                tr.delete(endToOffset, endToOffset + nodeSize).split(startFromOffset)// subtract 2(start, end tag length) to insert prev line
            ...
            return {
                ...
                toDOM: function(_a) {
                    ...
                    return [
                        'span',
                        {
                            class: clsWithMdPrefix.apply(void 0, classNames.split('|'))
                        },
                        0
                    ];
                }
...
var CodeBlock$1 = function(_super) {
            ...
            return {
                toDOM: function() {
                    return [
                        'span',
                        {
                            class: clsWithMdPrefix('code-block')
                        },
                        0
                    ];
                }
    ...
    CodeBlock.prototype.commands = function() {
        return function() {
            return function(state, dispatch) {
                ...
                dispatch(tr.setSelection(// subtract fenced syntax length and open, close tag(2)
...
function createTableHeader(columnCount) {
    return [
        createTableRow(columnCount),
        createTableRow(columnCount, true)
    ];
}
        ...
        return function(_a, dispatch) {
            ...
            if (cellNode) {
                ...
                if (isEmpty) {
                    ...
                    tr.split(endToOffset).insert(tr.mapping.map(endToOffset), createTextNode$1(schema, row))// should subtract `2` to selection end position considering ` |` text
...
var ThematicBreak$1 = function(_super) {
            ...
            return {
                toDOM: function() {
                    return [
                        'span',
                        {
                            class: clsWithMdPrefix('thematic-break')
                        },
                        0
                    ];
                }
...
var ListItem$1 = function(_super) {
        ...
        return function(_a, dispatch) {
            ...
            if (isEmpty) {
                ...
                if (changedResults === null || changedResults === void 0 ? void 0 : changedResults.length) {
                    ...
                    changedResults.unshift({
                        text: listSyntax + slicedText,
                        line: endIndex + 1
                    });
    ...
    ListItem.prototype.changeToListPerLine = function(tr, changedResults, _a) {
        ...
        var _loop_1 = function(i) {
            ...
            var changedResult = changedResults.filter(function(result) {
                return result.line - indexDiff === i;
            })[0];
            if (changedResult) {
...
function toggleMark(condition, syntax) {
    return function() {
        return function(_a, dispatch) {
            ...
            var conditionFn = !isFunction_1(condition) ? function(text) {
...
var TaskDelimiter = function(_super) {
            ...
            return {
                toDOM: function() {
                    return [
                        'span',
                        {
                            class: clsWithMdPrefix('delimiter', 'list-item')
                        },
                        0
                    ];
                }
            ...
            return {
                toDOM: function() {
                    return [
                        'span',
                        {
                            class: clsWithMdPrefix('delimiter')
                        },
                        0
                    ];
                }
...
var MarkedText = function(_super) {
            ...
            return {
                toDOM: function() {
                    return [
                        'span',
                        {
                            class: clsWithMdPrefix('marked-text')
                        },
                        0
                    ];
                }
            ...
            return {
                toDOM: function() {
                    return [
                        'span',
                        {
                            class: clsWithMdPrefix('table-cell')
                        },
                        0
                    ];
                }
...
var CustomBlock$1 = function(_super) {
            ...
            return {
                toDOM: function() {
                    return [
                        'span',
                        {
                            class: clsWithMdPrefix('custom-block')
                        },
                        0
                    ];
                }
            ...
            handleDOMEvents: {
                keyup: function(view, ev) {
                    ...
                    if (selection.empty && reTaskMarkerKey.test(ev.key)) {
                        ...
                        var mdPos = [
                            startIndex + 1,
                            from - startFromOffset + 1
                        ];
                        var mdNode = toastMark.findNodeAtPosition(mdPos);
                        var paraNode = findClosestNode(mdNode, function(node) {
                            var _a;
                            return node.type === 'paragraph' && ((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) === 'item';
                        });
...
var MdEditor = function(_super) {
    ...
    function MdEditor(eventEmitter, options) {
        ...
        _this.specs.setContext(__assign$1(__assign$1({}, _this.context), {
            view: _this.view
        }));
    ...
    MdEditor.prototype.createClipboard = function() {
        ...
        this.clipboard.addEventListener('paste', function(ev) {
            ...
            if (items) {
                var containRtfItem = toArray_1(items).some(function(item) {
                    return item.kind === 'string' && item.type === 'text/rtf';
                });
    ...
    MdEditor.prototype.createView = function() {
        var _this = this;
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorView"](this.el, {
    ...
    MdEditor.prototype.updateMarkdown = function(tr) {
        ...
        if (tr.docChanged) {
            tr.steps.forEach(function(step, index) {
                if (step.slice && !(step instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ReplaceAroundStep"])) {
    ...
    MdEditor.prototype.replaceSelection = function(text, start, end) {
        ...
        var slice = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Slice"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(nodes), 1, 1);
        this.focus();
        if (start && end) {
    ...
    MdEditor.prototype.addWidget = function(node, style, mdPos) {
        ...
        this.view.dispatch(tr.setMeta('widget', {
            pos: pos,
            node: node,
            style: style
        }));
...
var fromCodePoint$2 = // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
...
var Node$1 = function() {
    function Node1(nodeType, sourcepos) {
        this.parent = null;
        this.prev = null;
        this.next = null;
    ...
    Node1.prototype.isContainer = function() {
        return isContainer$1(this);
    };
    Node1.prototype.unlink = function() {
        if (this.prev) {
    ...
    Node1.prototype.replaceWith = function(node) {
        this.insertBefore(node);
        this.unlink();
    };
    Node1.prototype.insertAfter = function(sibling) {
        sibling.unlink();
    ...
    Node1.prototype.insertBefore = function(sibling) {
        sibling.unlink();
    ...
    Node1.prototype.appendChild = function(child) {
        child.unlink();
        child.parent = this;
        if (this.lastChild) {
    ...
    Node1.prototype.prependChild = function(child) {
        child.unlink();
        child.parent = this;
        if (this.firstChild) {
    ...
    Node1.prototype.walker = function() {
...
var TableCellNode = function(_super) {
...
var RefDefNode = function(_super) {
...
var CustomBlockNode = function(_super) {
...
var HtmlBlockNode = function(_super) {
...
var CustomInlineNode = function(_super) {
...
/*! http://mths.be/fromcodepoint v0.2.1 by @mathias */ var fromCodePoint;
...
var InlineParser = function() {
     ...
     **/ InlineParser.prototype.processEmphasis = function(stackBottom) {
        ...
        var openerFound;
        var oddMatch = false;
        var openersBottom = (_a = {}, _a[C_UNDERSCORE] = [
            stackBottom,
            stackBottom,
            stackBottom
        ], _a[C_ASTERISK] = [
                ...
                if (closerEmph || closercc === C_TILDE || closercc === C_DOLLAR) {
                    if (!openerFound) {
                        ...
                        newNode.sourcepos = [
                            [
                                openerEndPos[0],
                                openerEndPos[1] - useDelims + 1
                            ],
                            [
                                closerStartPos[0],
                                closerStartPos[1] + useDelims - 1
                            ]
                        ];
    ...
    InlineParser.prototype.getReferenceDefSourcepos = function(block) {
        ...
        return [
            ...
            [
                block.sourcepos[0][0] + lastLineOffset.line,
                lastLineOffset.ch
            ]
        ];
    };
...
var tableHead = function(parser, container) {
    ...
    if (container.type === 'paragraph' && !parser.indented && !parser.blank) {
        ...
        if (// not checking if the number of header cells and delimiter cells are the same
        ...
        var tableHeadRow_1 = createNode$1('tableRow', [
            ...
            [
                firstLineNum,
                firstLineStart + headerContent.length - 1
            ]
        ]);
        var tableDelimRow_1 = createNode$1('tableDelimRow', [
            [
                parser.lineNumber,
                parser.nextNonspace + 1
            ],
            [
                parser.lineNumber,
                parser.offset
...
var ToastMark = function() {
    ...
    ToastMark.prototype.updateLineTexts = function(startPos, endPos, newText) {
        ...
        (_a = this.lineTexts).splice.apply(_a, __spreadArray([
            startLine - 1,
            removedLineLen
        ], newLines));
    ...
    ToastMark.prototype.getRemovedNodeRange = function(extStartNode, extEndNode) {
        ...
        return {
            ...
            line: [
                extStartNode.sourcepos[0][0] - 1,
                extEndNode.sourcepos[1][0] - 1
            ]
        };
    };
...
var Renderer = function() {
    ...
    Renderer.prototype.render = function(rootNode) {
        ...
        var _loop_1 = function() {
            ...
            if (converted) {
                var htmlNodes = Array.isArray(converted) ? converted : [
                    converted
                ];
...
/*! @license DOMPurify 2.3.3 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/2.3.3/LICENSE */ function _toConsumableArray(arr) {
 ...
 * are not supported).
 */ var _createTrustedTypesPolicy = function _createTrustedTypesPolicy(trustedTypes, document1) {
    ...
    if (document1.currentScript && document1.currentScript.hasAttribute(ATTR_NAME)) {
        suffix = document1.currentScript.getAttribute(ATTR_NAME);
    }
...
function createDOMPurify() {
   ...
   */ DOMPurify.removed = [];
    ...
    if (typeof HTMLTemplateElement === 'function') {
        var template = document1.createElement('template');
        if (template.content && template.content.ownerDocument) {
            document1 = template.content.ownerDocument;
        }
    }
    var trustedTypesPolicy = _createTrustedTypesPolicy(trustedTypes, originalDocument);
    var emptyHTML = trustedTypesPolicy && RETURN_TRUSTED_TYPE ? trustedTypesPolicy.createHTML('') : '';
    var _document = document1, implementation = _document.implementation, createNodeIterator = _document.createNodeIterator, createDocumentFragment = _document.createDocumentFragment, getElementsByTagName = _document.getElementsByTagName;
    var importNode = originalDocument.importNode;
    var documentMode = {};
    try {
        documentMode = clone(document1).documentMode ? document1.documentMode : {};
    } catch (_) {}
    var hooks = {};
    /**
   ...
   * of importing it into a new Document and returning a sanitized copy */ var IN_PLACE = false;
    ...
    /* Ideally, do not touch anything below this line */ /* ______________________________________________ */ var formElement = document1.createElement('form');
    /**
   * _parseConfig
   *
   ...
   */ // eslint-disable-next-line complexity
    var _parseConfig = function _parseConfig(cfg) {
        ...
        /* Shield configuration object from tampering */ if (!cfg || (typeof cfg === 'undefined' ? 'undefined' : _typeof(cfg)) !== 'object') {
            cfg = {};
        }
   ...
   */ var _initDocument = function _initDocument(dirty) {
     ...
     */ if (NAMESPACE === HTML_NAMESPACE) {
        ...
        if (dirty && leadingWhitespace) {
            body.insertBefore(document1.createTextNode(leadingWhitespace), body.childNodes[0] || null);
        }
   ...
   */ var _isNode = function _isNode(object) {
        return (typeof Node1 === 'undefined' ? 'undefined' : _typeof(Node1)) === 'object' ? object instanceof Node1 : object && (typeof object === 'undefined' ? 'undefined' : _typeof(object)) === 'object' && typeof object.nodeType === 'number' && typeof object.nodeName === 'string';
    };
    /**
   * _executeHook
   ...
   */ // eslint-disable-next-line complexity
    var _isValidAttribute = function _isValidAttribute(lcTag, lcName, value) {
        /* Make sure attribute cannot clobber */ if (SANITIZE_DOM && (lcName === 'id' || lcName === 'name') && (value in document1 || value in formElement)) {
            return false;
        }
    ...
    if (customConvertors) {
        Object.keys(customConvertors).forEach(function(nodeType) {
            ...
            if (orgConvertor && isFunction_1(customConvertor)) {
                ...
                'htmlBlock',
                'htmlInline'
            ], nodeType) && !isFunction_1(customConvertor)) {
                convertors[nodeType] = function(node, context) {
    ...
    return {
        ...
        getAttrs: function(dom) {
            return [
                ...
                if (attrValue) {
                    acc[attrName] = includes([
                        'rawHTML',
                        'extended'
                    ], attrName) ? attrValue : Number(attrValue);
                }
                return acc;
            }, {});
        }
...
function getCustomAttrs(attrs) {
    ...
    return __assign$1(__assign$1({}, htmlAttrs), {
        class: classNames ? classNames.join(' ') : null
    });
}
...
function wrapInList(tr, _a, wrappers, joinBefore, list) {
    ...
    var content = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].empty;
    ...
    tr.step(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ReplaceAroundStep"](start - (joinBefore ? 2 : 0), end, start, end, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Slice"](content, 0, 0), wrappers.length, true));
...
function changeToList(tr, range, list, attrs) {
    ...
    if (depth >= 2 && $from.node(depth - 1).type.compatibleContent(list) && range.startIndex === 0 && $from.index(depth - 1)) {
        var start = tr.doc.resolve(range.start - 2);
        outerRange = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeRange"](start, start, depth);
        if (range.endIndex < range.parent.childCount) {
            range = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeRange"]($from, tr.doc.resolve($to.end(depth)), depth);
        }
        joinBefore = true;
    }
...
function changeList(list) {
    return function(_a, dispatch) {
        ...
        if (range) {
            var newTr = isInListNode($from) ? changeListType(tr, range, list) : changeToList(tr, range, list);
            dispatch(newTr);
            return true;
        }
        return false;
...
function toggleTask() {
    return function(_a, dispatch) {
        ...
        var range = $from.blockRange($to);
        if (range) {
            var newTr = isInListNode($from) ? toggleTaskListItems(tr, range) : changeToList(tr, range, schema.nodes.bulletList, {
                task: true
            });
            dispatch(newTr);
            return true;
...
function sinkListItem(listItem) {
    return function(_a, dispatch) {
        ...
        if (range && range.startIndex > 0) {
            ...
            var inner = nestedBefore ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(listItem.create()) : null;
            var slice = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Slice"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(listItem.create(null, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(parent_1.type.create(null, inner)))), nestedBefore ? 3 : 1, 0);
            var before = range.start;
            var after = range.end;
            tr.step(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ReplaceAroundStep"](before - (nestedBefore ? 3 : 1), after, before, after, slice, 1, true));
            dispatch(tr);
            return true;
        }
        return false;
...
function liftToOuterList(tr, range, listItem) {
    ...
    if (end < endOfList) {
        ...
        tr.step(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ReplaceAroundStep"](end - 1, endOfList, end, endOfList, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Slice"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(listItem.create(null, parent.copy())), 1, 0), 1, true));
        range = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeRange"](tr.doc.resolve($from.pos), tr.doc.resolve(endOfList), depth);
    }
    tr.lift(range, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["liftTarget"])(range));
    return tr;
}
...
function splitListItem(listItem) {
    return function(_a, dispatch) {
        ...
        if ($from.parent.content.size === 0 && $from.node(-1).childCount === $from.indexAfter(-1)) {
            ...
            if ($from.depth === 2 || $from.node(-3).type !== listItem || $from.index(-2) !== $from.node(-2).childCount - 1) {
                return false;
            }
            var keepItem = $from.index(-1) > 0;
            var wrapper = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].empty;
            // Build a fragment containing empty versions of the structure
            // from the outer list item to the parent node of the cursor
            for(var depth = $from.depth - (keepItem ? 1 : 2); depth >= $from.depth - 3; depth -= 1){
                wrapper = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from($from.node(depth).copy(wrapper));
            }
            // Add a second list item with an empty default start node
            wrapper = wrapper.append(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(listItem.createAndFill()));
            tr.replace(keepItem ? $from.before() : $from.before(-1), $from.after(-3), new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Slice"](wrapper, keepItem ? 3 : 2, 2));
            tr.setSelection(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"].near(tr.doc.resolve($from.pos + (keepItem ? 3 : 2))));
            dispatch(tr);
            return true;
        }
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canSplit"])(tr.doc, $from.pos, 2, types)) {
...
var cache = new Map();
/* eslint-disable @typescript-eslint/no-unused-vars */ var TableOffsetMap = function() {
    ...
    TableOffsetMap.prototype.getRectOffsets = function(startCellPos, endCellPos) {
        ...
        if (startCellPos.pos > endCellPos.pos) {
            _a = [
                endCellPos,
                startCellPos
            ], startCellPos = _a[0], endCellPos = _a[1];
        }
...
/* eslint-enable @typescript-eslint/no-unused-vars */ var createOffsetMap = function(headOrBody, startOffset) {
    var cellInfoMatrix = [];
...
function getSelectionRanges(doc, map, _a) {
    ...
    for(var rowIdx = startRowIdx; rowIdx <= endRowIdx; rowIdx += 1){
        for(var colIdx = startColIdx; colIdx <= endColIdx; colIdx += 1){
            ...
            ranges.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectionRange"](doc.resolve(offset + 1), doc.resolve(offset + nodeSize - 1)));
        }
    }
    return ranges;
}
function createTableFragment(tableHead, tableBody) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(fragment);
}
var CellSelection = function(_super) {
    ...
    CellSelection.prototype.map = function(doc, mapping) {
        ...
        if (this.offsetMap.totalColumnCount > map.totalColumnCount || this.offsetMap.totalRowCount > map.totalRowCount) {
            var depthMap = {
                tableBody: 1,
                tableRow: 2,
                tableCell: 3,
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextSelection"].create(doc, from);
        }
        return new CellSelection(startCell, endCell);
    };
    CellSelection.prototype.eq = function(cell) {
        return cell instanceof CellSelection && cell.startCell.pos === this.startCell.pos && cell.endCell.pos === this.endCell.pos;
    };
    CellSelection.prototype.content = function() {
        ...
        for(var rowIdx = startRowIdx; rowIdx <= endRowIdx; rowIdx += 1){
            ...
            var copiedRow = row.copy(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(cells));
            var targetNode = isTableHeadCell ? tableHead : tableBody;
            // @ts-ignore
            targetNode.content = targetNode.content.append(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(copiedRow));
        }
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Slice"](createTableFragment(tableHead, tableBody), 1, 1);
    };
    CellSelection.prototype.toJSON = function() {
        return JSON.stringify(this);
    };
    return CellSelection;
}(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"]);
...
function getTableContentFromSlice(slice) {
    ...
    if (slice.size) {
        ...
        while(content.childCount === 1 && (openStart > 0 && openEnd > 0 || ((_a = content.firstChild) === null || _a === void 0 ? void 0 : _a.type.name) === 'table')){
            openStart -= 1;
            openEnd -= 1;
            content = content.firstChild.content;
        }
        if (content.firstChild.type.name === 'tableHead' || content.firstChild.type.name === 'tableBody') {
            return content;
        }
    }
    return null;
...
var pluginKey = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PluginKey"]('cellSelection');
...
var TableSelection = function() {
    ...
    TableSelection.prototype.getCellPos = function(_a) {
        ...
        var mousePos = this.view.posAtCoords({
            left: clientX,
            top: clientY
        });
        if (mousePos) {
...
function drawCellSelection(_a) {
    ...
    if (selection instanceof CellSelection) {
        ...
        ranges.forEach(function(_a) {
            var $from = _a.$from, $to = _a.$to;
            cells_1.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Decoration"].node($from.pos - 1, $to.pos + 1, {
                class: SELECTED_CELL_CLASS_NAME
            }));
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DecorationSet"].create(doc, cells_1);
    }
    return null;
}
 ...
 */ var Map$1 = function() {
    ...
    Map1.prototype.getKeyIndex = function(key) {
    ...
    Map1.prototype.forEach = function(callback, thisArg) {
        var _this = this;
        if (thisArg === void 0) {
            thisArg = this;
        }
            ...
            handleDOMEvents: {
                mousedown: function(view, ev) {
                    ...
                    if (mousePos) {
                        ...
                        tr.setNodeMarkup(offset, null, __assign$1(__assign$1({}, attrs), {
...
var CustomBlockView = function() {
    function CustomBlockView(node, view, getPos, toDOMAdaptor) {
        ...
        this.openEditor = function() {
            ...
            _this.innerEditorView = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorView"](_this.innerViewContainer, {
                state: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorState"].create({
                    ...
                    plugins: [
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$keymap$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["keymap"])({
                            'Mod-z': function() {
                                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$history$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["undo"])(_this.innerEditorView.state, _this.innerEditorView.dispatch);
                            },
                            'Shift-Mod-z': function() {
                                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$history$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redo"])(_this.innerEditorView.state, _this.innerEditorView.dispatch);
                            },
                            Tab: function(state, dispatch) {
                                dispatch(state.tr.insertText('\t'));
                                return true;
                            },
                            Enter: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["newlineInCode"],
                            Escape: function() {
                                _this.cancelEditing();
                                return true;
                            },
    ...
    CustomBlockView.prototype.cancelEditing = function() {
        var undoableCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$history$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["undoDepth"])(this.innerEditorView.state);
        this.canceled = true;
        // should undo editing result
        // eslint-disable-next-line no-plusplus
        while(undoableCount--){
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$history$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["undo"])(this.innerEditorView.state, this.innerEditorView.dispatch);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$history$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["undo"])(this.editorView.state, this.editorView.dispatch);
        }
        this.canceled = false;
        var to = this.editorView.state.selection.to;
        var outerState = this.editorView.state;
        this.editorView.dispatch(outerState.tr.setSelection(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextSelection"].create(outerState.doc, to)));
        this.editorView.focus();
        this.closeEditor();
    };
    CustomBlockView.prototype.dispatchInner = function(tr) {
        ...
        if (!this.canceled && isFunction_1(this.getPos)) {
            ...
            var offsetMap = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StepMap"].offset(this.getPos() + 1);
...
var ImageView = function() {
    function ImageView(node, view, getPos, eventEmitter) {
        ...
        this.handleMousedown = function(ev) {
            ...
            if (_this.imageLink && isFunction_1(_this.getPos) && hasClass_1(target, IMAGE_LINK_CLASS_NAME)) {
                var style = getComputedStyle(target, ':before');
                ev.stopPropagation();
...
function changePastedSlice(slice, schema, isInTable) {
    ...
    content.forEach(function(node) {
        if (node.type.name === 'table') {
            var tableContent = getTableContentFromSlice(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Slice"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(node), 0, 0));
            if (tableContent) {
...
function replaceCells(tr, pastingRows, cellsOffsets, map) {
    ...
    cellsOffsets.forEach(function(offsets, index) {
        ...
        var cells = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Slice"](pastingRows[index], 0, 0);
    ...
    Heading.prototype.commands = function() {
        return function(payload) {
            return function(state, dispatch) {
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setBlockType"])(nodeType, payload)(state, dispatch);
            };
        };
    };
    return Heading;
...
var CodeBlock = function(_super) {
                ...
                parseDOM: [
                    {
                        ...
                        getAttrs: function(dom) {
                            ...
                            return __assign$1({
                                language: (child === null || child === void 0 ? void 0 : child.getAttribute('data-language')) || null
                            }, rawHTML && {
                                rawHTML: rawHTML
                            });
                        }
    ...
    CodeBlock.prototype.commands = function() {
        return function() {
            return function(state, dispatch) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setBlockType"])(state.schema.nodes.codeBlock)(state, dispatch);
            };
        };
    };
        ...
        return function(state, dispatch) {
            ...
            if (view.endOfTextblock(direction) && $from.node().type.name === 'codeBlock') {
                ...
                var range = direction === 'up' ? [
                    offset,
                    lines[0].length + offset
                ] : [
                    offset - last$1(lines).length,
                    offset
                ];
...
var BulletList = function(_super) {
    ...
    BulletList.prototype.changeList = function() {
        return function(state, dispatch) {
            return changeList(state.schema.nodes.bulletList)(state, dispatch);
        };
    };
...
var OrderedList = function(_super) {
                ...
                parseDOM: [
                    {
                        ...
                        getAttrs: function(dom) {
                            ...
                            var rawHTML = dom.getAttribute('data-raw-html');
                            return __assign$1({
                                order: dom.hasAttribute('start') ? Number(start) : 1
                            }, rawHTML && {
                                rawHTML: rawHTML
                            });
                        }
    ...
    OrderedList.prototype.commands = function() {
        return function() {
            return function(state, dispatch) {
                return changeList(state.schema.nodes.orderedList)(state, dispatch);
            };
        };
    };
                ...
                parseDOM: [
                    {
                        ...
                        getAttrs: function(dom) {
                            ...
                            return __assign$1({
                                ...
                                checked: dom.hasAttribute('data-task-checked')
                            }, rawHTML && {
                                rawHTML: rawHTML
                            });
                        }
...
var BlockQuote = function(_super) {
    ...
    BlockQuote.prototype.commands = function() {
        return function() {
            return function(state, dispatch) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["wrapIn"])(state.schema.nodes.blockQuote)(state, dispatch);
            };
        };
    };
    BlockQuote.prototype.keymaps = function() {
...
function canMoveToBeforeCell(direction, _a, from, doc, inList) {
    ...
    if (direction === "left" /* LEFT */  || direction === "up" /* UP */ ) {
        if (inList && !isInFirstListItem(from, doc, [
            paraDepth,
            listDepth
        ])) {
            return false;
...
function canMoveBetweenCells(direction, _a, from, doc) {
    ...
    var moveBeforeCell = canMoveToBeforeCell(direction, [
        paraDepth,
        listDepth,
        curDepth
    ], from, doc, inList);
...
function canBeOutOfTable(direction, map, _a) {
    ...
    var inLastRow = direction === "down" /* DOWN */  && ((rowspanInfo === null || rowspanInfo === void 0 ? void 0 : rowspanInfo.count) > 1 ? rowIdx + rowspanInfo.count - 1 : rowIdx) === map.totalRowCount - 1;
...
function addParagraphBeforeTable(tr, map, schema) {
    ...
    return tr.setSelection(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"].near(tableStartPos, -1));
}
function addParagraphAfterTable(tr, map, schema, forcedAddtion) {
    ...
    return tr.setSelection(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"].near(tableEndPos, 1));
}
...
function moveToCell(direction, tr, cellIndex, map) {
    ...
    if (offset) {
        ...
        return tr.setSelection(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"].near(tr.doc.resolve(offset), dir));
    }
    return null;
}
...
function selectNode(tr, pos, depth) {
    ...
    return tr.setSelection(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeSelection"](tablePos));
}
...
var Table = function(_super) {
    ...
    Object.defineProperty(Table.prototype, "schema", {
        get: function() {
            return {
                ...
                parseDOM: [
                    createDOMInfoParsedRawHTML('table')
                ],
                toDOM: function(_a) {
                    var attrs = _a.attrs;
                    return [
    ...
    Table.prototype.moveInCell = function(direction) {
        ...
        return function(state, dispatch) {
            ...
            if (cell) {
                ...
                if (para && canMoveBetweenCells(direction, [
                    cellDepth,
                    para.depth
                ], $from, doc)) {
    ...
    Table.prototype.deleteCells = function() {
        return function(state, dispatch) {
            var schema = state.schema, selection = state.selection, tr = state.tr;
            var _a = getResolvedSelection(selection), anchor = _a.anchor, head = _a.head;
            var textSelection = selection instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextSelection"];
    ...
    Object.defineProperty(TableHead.prototype, "schema", {
        get: function() {
            return {
                ...
                parseDOM: [
                    createDOMInfoParsedRawHTML('thead')
                ],
                toDOM: function(_a) {
                    var attrs = _a.attrs;
                    return [
        ...
        get: function() {
            return {
                ...
                toDOM: function(_a) {
                    ...
                    return [
                        'th',
                        __assign$1(__assign$1({}, cellAttrs), getCustomAttrs(attrs)),
                        0
                    ];
                }
            };
...
var TableBodyCell = function(_super) {
        ...
        get: function() {
            return {
                ...
                parseDOM: [
                    {
                        tag: 'img[src]',
                        getAttrs: function(dom) {
                            var sanitizedDOM = sanitizeHTML(dom, {
                ...
                toDOM: function(_a) {
                    ...
                    return [
                        attrs.rawHTML || 'img',
                        __assign$1(__assign$1({
                            src: escapeXml$1(attrs.imageUrl)
                        }, attrs.altText && {
                            alt: attrs.altText
                        }), getCustomAttrs(attrs))
                    ];
    ...
    Image.prototype.addImage = function() {
        return function(payload) {
            return function(_a, dispatch) {
                ...
                var node = schema.nodes.image.createAndFill(__assign$1({
                    imageUrl: imageUrl
                }, altText && {
                    altText: altText
                }));
...
var ThematicBreak = function(_super) {
    __extends$1(ThematicBreak, _super);
    function ThematicBreak() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
...
var Strong = function(_super) {
    ...
    Strong.prototype.bold = function() {
        return function() {
            return function(state, dispatch) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toggleMark"])(state.schema.marks.strong)(state, dispatch);
            };
        };
    };
    Strong.prototype.commands = function() {
...
var Emph = function(_super) {
    ...
    Emph.prototype.italic = function() {
        return function() {
            return function(state, dispatch) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toggleMark"])(state.schema.marks.emph)(state, dispatch);
            };
        };
    };
    Emph.prototype.commands = function() {
...
var Strike = function(_super) {
    ...
    Strike.prototype.commands = function() {
        return function() {
            return function(state, dispatch) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toggleMark"])(state.schema.marks.strike)(state, dispatch);
            };
        };
    };
    Strike.prototype.keymaps = function() {
...
var Link = function(_super) {
            ...
            return {
                ...
                toDOM: function(_a) {
                    ...
                    return [
                        attrs.rawHTML || 'a',
                        __assign$1(__assign$1({
                            href: escapeXml$1(attrs.linkUrl)
                        }, _this.linkAttributes), getCustomAttrs(attrs))
                    ];
                }
            };
        },
    ...
    Link.prototype.toggleLink = function() {
        return function(payload) {
            return function(state, dispatch) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toggleMark"])(state.schema.marks.link, payload)(state, dispatch);
            };
        };
    };
    Link.prototype.commands = function() {
...
var Code = function(_super) {
    ...
    Code.prototype.commands = function() {
        return function() {
            return function(state, dispatch) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toggleMark"])(state.schema.marks.code)(state, dispatch);
            };
        };
    };
    Code.prototype.keymaps = function() {
...
var CustomBlock = function(_super) {
    __extends$1(CustomBlock, _super);
    function CustomBlock() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
            ...
            return {
                ...
                toDOM: function(_a) {
                    ...
                    return [
                        'div',
                        {
                            'data-custom-info': attrs.info || null
                        },
                        0
                    ];
                }
    ...
    CustomBlock.prototype.commands = function() {
        return function(payload) {
            return function(state, dispatch) {
                return (payload === null || payload === void 0 ? void 0 : payload.info) ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$commands$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setBlockType"])(state.schema.nodes.customBlock, payload)(state, dispatch) : false;
            };
        };
    };
    return CustomBlock;
}(Node$2);
var FrontMatter = function(_super) {
...
var WysiwygEditor = function(_super) {
    ...
    WysiwygEditor.prototype.createView = function() {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EditorView"](this.el, {
            ...
            nodeViews: __assign$1({
                customBlock: function(node, view, getPos) {
            ...
            handlePaste: function(view, _, slice) {
                return pasteToTable(view, slice);
            },
            handleKeyDown: function(_, ev) {
                _this.eventEmitter.emit('keydown', _this.editorType, ev);
                return false;
    ...
    WysiwygEditor.prototype.replaceSelection = function(text, start, end) {
        ...
        var slice = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Slice"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"].from(paras), 1, 1);
        var newTr = isNumber_1(start) && isNumber_1(end) ? tr.replaceRange(start, end, slice) : tr.replaceSelection(slice);
        this.view.dispatch(newTr);
        this.focus();
    };
    ...
    WysiwygEditor.prototype.addWidget = function(node, style, pos) {
        ...
        dispatch(state.tr.setMeta('widget', {
            pos: pos !== null && pos !== void 0 ? pos : state.selection.to,
            node: node,
            style: style
        }));
    };
    ...
    WysiwygEditor.prototype.getRangeInfoOfNode = function(pos) {
        ...
        if (marks.length || type === 'paragraph') {
            ...
            node.forEach(function(child, offset) {
                ...
                if (isText && offset <= startOffset && offset + nodeSize >= startOffset && maybeHasMark_1(nodeMarks)) {
                    start = start + offset;
                    end = start + nodeSize;
                }
            });
 ...
 */ var EventEmitter = function() {
     ...
     */ EventEmitter.prototype.emitReduce = function(type, source) {
        ...
        if (!this.hold && eventHandlers) {
            eventHandlers.forEach(function(handler) {
                var result = handler.apply(void 0, __spreadArray$1([
                    source
                ], args));
                if (!isFalsy_1(result)) {
                    source = result;
...
var convertors = {
    ...
    img: function(state, node, openTagName) {
        ...
        if (openTagName) {
            ...
            state.addNode(image, __assign$1({
                rawHTML: openTagName,
                imageUrl: imageUrl
            }, altText && {
                altText: altText
    ...
    pre: function(state, node, openTagName) {
        ...
        state.openNode(state.schema.nodes.codeBlock, {
            rawHTML: openTagName
        });
    ...
    li: function(state, node, openTagName) {
        ...
        if (((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) === 'tableCell') {
            ...
            if (openTagName) {
                ...
                state.openNode(listItem, __assign$1({
                    rawHTML: openTagName
                }, attrs));
                if (node.next && !isListNode(node.next)) {
                    state.openNode(paragraph);
...
var toWwConvertors = {
    ...
    heading: function(state, node, _a, customAttrs) {
        ...
        if (entering) {
            ...
            state.openNode(state.schema.nodes.heading, __assign$1({
                level: level,
    ...
    codeBlock: function(state, node, customAttrs) {
        ...
        state.openNode(codeBlock, __assign$1({
            language: info
        }, customAttrs));
        state.addText(getTextWithoutTrailingNewline(literal || ''));
        state.closeNode();
    ...
    list: function(state, node, _a, customAttrs) {
        ...
        if (entering) {
            ...
            if (type === 'bullet') {
                ...
                state.openNode(orderedList, __assign$1({
                    order: start
                }, customAttrs));
            }
        } else {
    ...
    item: function(state, node, _a, customAttrs) {
        ...
        if (entering) {
            var attrs = __assign$1(__assign$1(__assign$1({}, task && {
                task: task
            }), checked && {
                checked: checked
            }), customAttrs);
    ...
    image: function(state, node, _a, customAttrs) {
        ...
        state.addNode(image, __assign$1(__assign$1({
            imageUrl: destination
        }, firstChild && {
            altText: firstChild.literal
        }), customAttrs));
    },
    ...
    htmlInline: function(state, node) {
        ...
        if (markType === null || markType === void 0 ? void 0 : markType.spec.attrs.htmlInline) {
            if (openTagName) {
                ...
                state.openMark(markType.create({
                    htmlAttrs: htmlAttrs
                }));
            } else {
    ...
    customInline: function(state, node, _a) {
        ...
        if (info.indexOf('widget') !== -1 && entering) {
            var content = getWidgetContent(node);
            skipChildren();
            state.addNode(schema.nodes.widget, {
                info: info
            }, [
...
function createWwConvertors(customConvertors) {
    ...
    customConvertorTypes.forEach(function(type) {
        ...
        if (wwConvertor && !includes([
            'htmlBlock',
            'htmlInline'
        ], type)) {
            convertors[type] = function(state, node, context) {
                context.origin = function() {
                    return orgConvertors[type](node, context, orgConvertors);
                };
...
function mergeMarkText(a, b) {
    if (a.isText && b.isText && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mark"].sameSet(a.marks, b.marks)) {
        // @ts-ignore
...
var ToWwConvertorState = function() {
    function ToWwConvertorState(schema, convertors) {
        ...
        this.marks = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mark"].none;
    }
    ...
    ToWwConvertorState.prototype.convertByDOMParser = function(root) {
        var _this = this;
        var doc = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DOMParser"].fromSchema(this.schema).parse(root);
        doc.content.forEach(function(node) {
            return _this.push(node);
        });
    };
            ...
            if (convertor) {
                ...
                if ((infoForPosSync === null || infoForPosSync === void 0 ? void 0 : infoForPosSync.node) === node) {
                    var pos = this_1.stack.reduce(function(nodeSize, stackItem) {
                        return nodeSize + stackItem.content.reduce(function(contentSize, pmNode) {
...
var nodeTypeWriters = {
    ...
    blockQuote: function(state, _a, _b) {
        ...
        state.wrapBlock(delim, null, node, function() {
            return state.convertNode(node);
        });
    },
    bulletList: function(state, _a, _b) {
        ...
        var delim = _b.delim;
        // soft-tab(4)
        state.convertList(node, repeat$1(' ', 4), function() {
            return delim + " ";
        });
    },
...
var toMdConvertors = {
    ...
    code: function(_a, _b) {
        ...
        var entering = _b.entering;
        var delim = entering ? addBackticks(parent.child(index), -1) : addBackticks(parent.child(index - 1), 1);
        var rawHTML = entering ? getOpenRawHTML(node.attrs.rawHTML) : getCloseRawHTML(node.attrs.rawHTML);
        return {
            delim: delim,
            rawHTML: rawHTML
        };
...
function createMarkTypeConvertors(convertors) {
    ...
    markTypes.forEach(function(type) {
        markTypeConvertors[type] = function(nodeInfo, entering) {
            ...
            var params = runConvertor ? convertor(nodeInfo, {
                entering: entering
            }) : {};
...
var ToMdConvertorState = function() {
    ...
    ToMdConvertorState.prototype.markText = function(mark, entering, parent, index) {
        ...
        if (convertor) {
            var _a = convertor({
                ...
                parent: parent,
                index: index
            }, entering), delim = _a.delim, rawHTML = _a.rawHTML;
    ...
    ToMdConvertorState.prototype.convertInline = function(parent) {
        ...
        var progress = function(node, _, index) {
            ...
            var removedWhitespace = node && node.isText && marks.some(function(mark) {
            ...
            if (node) {
                ...
                if (noEscape && node.isText) {
                    _this.text(_this.markText(lastMark, true, parent, index) + node.text + _this.markText(lastMark, false, parent, index + 1), false);
                } else {
    ...
    ToMdConvertorState.prototype.convertList = function(node, delim, firstDelimFn) {
        ...
        node.forEach(function(child, _, index) {
            ...
            _this.wrapBlock(delim, firstDelimFn(index), node, function() {
                return _this.convertBlock(child, node, index);
            });
        });
    ...
    ToMdConvertorState.prototype.convertNode = function(parent, infoForPosSync) {
        ...
        parent.forEach(function(node, _, index) {
            ...
            if ((infoForPosSync === null || infoForPosSync === void 0 ? void 0 : infoForPosSync.node) === node) {
                ...
                infoForPosSync.setMappedPos([
                    lineTexts.length,
                    last$1(lineTexts).length + 1
                ]);
            }
        });
        return this.result;
...
var Convertor = function() {
    function Convertor(schema, toMdConvertors, toHTMLConvertors, eventEmitter) {
        ...
        this.eventEmitter.listen('setFocusedNode', function(node) {
            return _this.focusedNode = node;
        });
    }
...
function execPlugin(pluginInfo) {
    ...
    var pmState = {
        Plugin: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Plugin"],
        PluginKey: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PluginKey"],
        Selection: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Selection"],
        TextSelection: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextSelection"]
    };
    var pmView = {
        Decoration: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Decoration"],
        DecorationSet: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$view$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DecorationSet"]
    };
    var pmModel = {
        Fragment: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"]
    };
    var pmRules = {
        InputRule: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$inputrules$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InputRule"],
        inputRules: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$inputrules$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["inputRules"],
        undoInputRule: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$inputrules$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["undoInputRule"]
    };
    var pmKeymap = {
        keymap: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$keymap$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["keymap"]
    };
    var context = {
 ...
 */ var ToastUIEditorViewer = function() {
     ...
     */ ToastUIEditorViewer.prototype.setMarkdown = function(markdown) {
        ...
        var editResult = this.toastMark.editMarkdown([
            1,
            1
        ], endSourcepos, markdown || '');
...
function isPmNode(node) {
    return node instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Node"];
}
...
function createMdLikeNode(node) {
    ...
    if (htmlAttrs) {
        return __assign$1(__assign$1({}, attributes), {
            attrs: htmlAttrs,
            childrenHTML: childrenHTML
        });
    }
    ...
    WwToDOMAdaptor.prototype.generateTokens = function(node) {
        ...
        var context = {
            ...
            getChildrenText: function() {
                return isPmNode(node) ? node.textContent : '';
            },
            skipChildren: function() {
                return false;
            }
        ...
        var tokens = isArray_1(converted) ? converted : [
            converted
        ];
        if (isContainer(node.type.name) || node.attrs.htmlInline) {
            ...
            tokens.push({
                type: 'text',
                content: isPmNode(node) ? node.textContent : ''
            });
...
var ScrollSync = function() {
    ...
    ScrollSync.prototype.syncPreviewScrollTop = function(editing) {
        ...
        var posInfo = editorView.posAtCoords({
            left: left,
            top: top
        });
 ...
 */ var ToastUIEditorCore = function() {
     ...
     */ ToastUIEditorCore.prototype.setHTML = function(html, cursorToEnd) {
        ...
        var wwNode = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DOMParser"].fromSchema(this.wwEditor.schema).parse(container);
...
/* eslint-disable */ function html$1(n) {
    for(var l, e, s = arguments, t = 1, r = '', u = '', a = [
        ...
        h && (t === 1 && c(), c(h));
        for(let i = 0; i < n[h].length; i++)l = n[h][i], t === 1 ? l === '<' ? (c(), a = [
            a,
            '',
            null
        ], t = 3) : r += l : t === 4 ? r === '--' && l === '>' ? (t = 1, r = '') : r = l + r[0] : u ? l === u ? u = '' : r += l : l === '"' || l === "'" ? u = l : l === '>' ? (c(), t = 1) : t && (l === '=' ? (t = 5, e = r, r = '') : l === '/' && (t < 5 || n[h][i + 1] === '>') ? (c(), t === 3 && (a = a[0]), t = a, (a = a[0]).push(this.apply(null, t.slice(1))), t = 0) : l === ' ' || l === '\t' || l === '\n' || l === '\r' ? (c(), t = 2) : r += l), t === 3 && r === '!--' && (t = 4, a = a[0]);
    }
...
function innerDiff(node, prevProps, nextProps) {
    ...
    setProps(node, prevProps, nextProps, function(propName) {
...
function setStyleProps(node, prevStyleProps, styleProps) {
    ...
    Object.keys(styleProps).forEach(function(styleProp) {
        ...
        // @ts-ignore
        node.style[styleProp] = isNumber_1(value) && !reNonDimension.test(styleProp) ? value + "px" : value;
    });
}
...
function render(container, vnode) {
    var root = new VNode(container.tagName.toLowerCase(), {}, [
        vnode
    ]);
    root.node = container;
    VNode.removalNodes = [];
 ...
 */ function debounce$1(fn, delay) {
    var timer, args;
    /* istanbul ignore next */ delay = delay || 0;
    function debounced() {
 ...
 */ function throttle$1(fn, interval) {
    ...
    /* istanbul ignore next */ interval = interval || 0;
...
var HeadingPopupBody = function(_super) {
...
var Tabs = function(_super) {
    ...
    Tabs.prototype.render = function() {
        ...
        return html(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject([
            ...
            }, i18n.get(text), isActive ? 'true' : 'false', isActive ? '0' : '-1', i18n.get(text));
        }));
    };
    return Tabs;
}(Component);
...
var TYPE_UI = 'ui';
var ImagePopupBody = function(_super) {
    ...
    ImagePopupBody.prototype.emitAddImageBlob = function() {
        ...
        this.setState({
            fileNameElClassName: fileNameElClassName
        });
    };
    ...
    ImagePopupBody.prototype.render = function() {
        ...
        return html(templateObject_1$e || (templateObject_1$e = __makeTemplateObject([
            ...
            ">\n            ",
            "\n          </button>\n        </div>\n      </div>\n    "
        ])), i18n.get('Insert image'), Tabs, this.tabs, activeTab, this.toggleTab, activeTab === 'url' ? 'block' : 'none', i18n.get('Image URL'), function(el) {
            return _this.refs.url = el;
        }, activeTab === 'file' ? 'block' : 'none', i18n.get('Select image file'), cls('file-name'), file ? ' has-file' : fileNameElClassName, this.showFileSelectBox, this.preventSelectStart, file ? file.name : i18n.get('No file'), cls('file-select-button'), this.showFileSelectBox, i18n.get('Choose a file'), this.changeFile, function(el) {
            return _this.refs.file = el;
        }, i18n.get('Description'), function(el) {
            return _this.refs.altText = el;
...
var LinkPopupBody = function(_super) {
    ...
    LinkPopupBody.prototype.render = function() {
        ...
        return html(templateObject_1$d || (templateObject_1$d = __makeTemplateObject([
            ...
            ">\n            ",
            "\n          </button>\n        </div>\n      </div>\n    "
        ])), i18n.get('Insert link'), i18n.get('URL'), function(el) {
            return _this.refs.url = el;
        }, i18n.get('Link text'), function(el) {
            return _this.refs.text = el;
        }, cls('button-container'), cls('close-button'), this.props.hidePopup, i18n.get('Cancel'), cls('ok-button'), this.execCommand, i18n.get('OK'));
    };
...
var BORDER_WIDTH = 1;
var TablePopupBody = function(_super) {
    ...
    TablePopupBody.prototype.createTableArea = function(tableRange) {
        ...
        for(var i = 0; i < rowIdx; i += 1){
            ...
            for(var j = 0; j < colIdx; j += 1){
                ...
                cells.push(html(templateObject_1$c || (templateObject_1$c = __makeTemplateObject([
                    "<div class=\"",
                    "\"></div>"
                ], [
                    "<div class=\"",
            ...
            rows.push(html(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject([
                "<div class=\"",
                "\">",
                "</div>"
            ], [
        ...
        return html(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject([
            "<div class=\"",
            "\">",
            "</div>"
        ], [
    ...
    TablePopupBody.prototype.render = function() {
        ...
        return html(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject([
            ...
            "\">",
            "</p>\n      </div>\n    "
        ])), i18n.get('Insert table'), cls('table-selection'), function(el) {
            return _this.refs.tableEl = el;
...
var CustomPopupBody = function(_super) {
...
function createPopupInfo(type, payload) {
    ...
    switch(type){
        case 'heading':
            return {
                render: function(props) {
                    return html(templateObject_1$a || (templateObject_1$a = __makeTemplateObject([
                        "<",
                        " ...",
                        " />"
                    ], [
        ...
        case 'link':
            return {
                render: function(props) {
                    return html(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject([
                        "<",
                        " ...",
                        " />"
                    ], [
        ...
        case 'image':
            return {
                render: function(props) {
                    return html(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject([
                        "<",
                        " ...",
                        " />"
                    ], [
            ...
            return __assign$1({
                render: function(props) {
                    return html(templateObject_5 || (templateObject_5 = __makeTemplateObject([
                        ...
                        " body=",
                        " />"
                    ])), CustomPopupBody, props, popup.body);
                },
                fromEl: el,
                pos: pos
            }, popup);
...
function groupToolbarItems(toolbarItems, hiddenScrollSync) {
    ...
    return toolbarItems.reduce(function(acc, item) {
        acc.push(item.map(function(type) {
...
function toggleScrollSync(toolbarItems, hiddenScrollSync) {
    toolbarItems.forEach(function(group) {
        group.forEach(function(item) {
            return item.hidden = item.name === 'scrollSync' && hiddenScrollSync;
        });
        setGroupState(group);
    });
}
...
var Popup = function(_super) {
    ...
    Popup.prototype.render = function() {
        ...
        var popupStyle = __assign$1(__assign$1({
            display: show ? 'block' : 'none'
        }, style), this.state.popupPos);
        return html(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject([
            ...
            "\">\n          ",
            "\n        </div>\n      </div>\n    "
        ])), cls('popup'), className, popupStyle, function(el) {
            return _this.refs.el = el;
        }, cls('popup-body'), render && render({
            eventEmitter: eventEmitter,
            show: show,
            hidePopup: hidePopup,
        ...
        function ButtonHOC(props) {
            ...
            _this.showTooltip = function(el) {
                ...
                if (!_this.props.disabled && tooltip) {
                    ...
                    css_1(_this.props.tooltipRef.current, {
                        display: 'block',
                        left: left,
                        top: top_1
                    });
        ...
        ButtonHOC.prototype.addEvent = function() {
            ...
            if (item.state) {
                eventEmitter.listen('changeToolbarState', function(_a) {
                    ...
                    _this.setState({
                        active: !!active,
                        disabled: disabled !== null && disabled !== void 0 ? disabled : _this.props.disabled
                    });
                });
            }
        };
...
var ToolbarButtonComp = function(_super) {
    ...
    function ToolbarButtonComp() {
        ...
        _this.execCommand = function() {
            ...
            if (command) {
                ...
                var initialValues = eventEmitter.emit('query', 'getPopupInitialValues', {
                    popupName: popupName
                })[0];
    ...
    ToolbarButtonComp.prototype.render = function() {
        ...
        return html(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject([
            ...
            return _this.refs.el = el;
        }, style, classNames, this.execCommand, this.showTooltip, hideTooltip, !!disabled, item.text || item.tooltip || '', item.text || '');
    };
    return ToolbarButtonComp;
}(Component);
var ToolbarButton = connectHOC(ToolbarButtonComp);
var templateObject_1$7;
var CustomToolbarItemComp = function(_super) {
    ...
    CustomToolbarItemComp.prototype.updated = function(prevProps) {
        ...
        if (prevProps.active !== active || prevProps.disabled !== disabled) {
            (_a = item.onUpdated) === null || _a === void 0 ? void 0 : _a.call(item, {
                active: active,
                disabled: disabled
            });
        }
...
var ToolbarGroup = function(_super) {
    ...
    ToolbarGroup.prototype.render = function() {
        ...
        var groupStyle = group.hidden ? {
            display: 'none'
        } : null;
        var dividerStyle = hiddenDivider ? {
            display: 'none'
        } : null;
        return html(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject([
            ...
            return html(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject([
                ...
                " item=",
                " />"
            ])), Comp, item.name, _this.props, item);
...
var POPUP_INDENT = 4;
var DropdownToolbarButtonComp = function(_super) {
    ...
    function DropdownToolbarButtonComp(props) {
        ...
        _this.handleClickDocument = function(_a) {
            var target = _a.target;
            if (!closest(target, "." + cls('dropdown-toolbar')) && !closest(target, '.more')) {
                _this.setState({
                    showDropdown: false,
                    dropdownPos: null
                });
    ...
    DropdownToolbarButtonComp.prototype.render = function() {
        ...
        var groupStyle = visibleItems.length ? null : {
            display: 'none'
        };
        var dropdownStyle = showDropdown ? null : {
            display: 'none'
        };
        return html(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject([
            ...
            "\n        >\n          ",
            "\n        </div>\n      </div>\n    "
        ])), cls('toolbar-group'), groupStyle, function(el) {
            return _this.refs.el = el;
        }, item.className, function() {
            return _this.setState({
                showDropdown: true
            });
        }, this.showTooltip, hideTooltip, disabled, cls('dropdown-toolbar'), __assign$1(__assign$1({}, dropdownStyle), dropdownPos), function(el) {
            return _this.refs.dropdownEl = el;
        }, visibleItems.length ? visibleItems.map(function(group, index) {
            var _a;
            return html(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject([
                ...
                "\n                    ...",
                "\n                  />\n                "
            ])), ToolbarGroup, group, index === visibleItems.length - 1 || ((_a = visibleItems[index + 1]) === null || _a === void 0 ? void 0 : _a.hidden), _this.props);
        }) : null);
    };
...
var Toolbar = function(_super) {
    ...
    Toolbar.prototype.render = function() {
        ...
        var toolbarStyle = previewStyle === 'tab' ? {
        ...
        return html(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject([
            ...
            "\n          execCommand=",
            "\n        />\n      </div>\n    "
        ])), cls('toolbar'), cls('md-tab-container'), editorType === 'wysiwyg' || previewStyle === 'vertical' ? 'none' : 'block', Tabs, this.tabs, activeTab, this.toggleTab, cls('defaultUI-toolbar'), function(el) {
            return _this.refs.el = el;
        }, toolbarStyle, items.map(function(group, index) {
            var _a;
...
var ContextMenu = function(_super) {
    ...
    ContextMenu.prototype.getMenuGroupElements = function() {
        ...
        return pos ? menuGroups.reduce(function(acc, group) {
            ...
            acc.push(html(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject([
                "<ul class=\"menu-group\">\n              ",
                "\n            </ul>"
            ], [
                "<ul class=\"menu-group\">\n              ",
    ...
    ContextMenu.prototype.render = function() {
        ...
        return html(templateObject_3 || (templateObject_3 = __makeTemplateObject([
            ...
            " aria-role=\"menu\">\n      ",
            "\n    </div>"
        ])), cls('context-menu'), style, this.getMenuGroupElements());
    };
    return ContextMenu;
}(Component);
...
var Layout = function(_super) {
    ...
    Layout.prototype.render = function() {
        ...
        return html(templateObject_2 || (templateObject_2 = __makeTemplateObject([
            ...
            " eventEmitter=",
            " />\n      </div>\n    "
        ])), themeClassName, cls('defaultUI'), displayClassName, function(el) {
            return _this.refs.el = el;
        }, Toolbar, function(toolbar) {
            return _this.toolbar = toolbar;
        }, eventEmitter, previewStyle, toolbarItems, editorType, cls('main'), editorTypeClassName, function(el) {
            return _this.refs.editorSection = el;
        }, cls('main-container'), cls('md-container'), previewClassName, function(el) {
            return _this.refs.mdContainer = el;
        }, cls('md-splitter'), cls('ww-container'), function(el) {
            return _this.refs.wwContainer = el;
        }, !hideModeSwitch && html(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject([
            "<",
            " eventEmitter=",
            " editorType=",
            " />"
            ...
            " editorType=",
            " />"
        ])), Switch, eventEmitter, editorType), ContextMenu, eventEmitter);
    };
 ...
 */ var ToastUIEditor = function(_super) {
    ...
    function ToastUIEditor(options) {
        ...
        (_a = _this.pluginInfo.toolbarItems) === null || _a === void 0 ? void 0 : _a.forEach(function(toolbarItem) {
            ...
            _this.defaultUI.insertToolbarItem({
...
//# sourceMappingURL=node_modules_%40toast-ui_editor_dist_esm_index_9260e125.js.map